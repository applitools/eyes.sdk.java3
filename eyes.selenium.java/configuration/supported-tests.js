module.exports = [
  ...
  // There is no signature in java SDK for usage both matchTimeout and stitchContent
  ...
  {name: 'TestCheckWindowWithIgnoreRegion_Fluent', executionMode: {isVisualGrid: true}, disabled: true },
  ...
  {name: 'TestCheckFixedRegion', executionMode: {isCssStitching: true}, disabled: true},
