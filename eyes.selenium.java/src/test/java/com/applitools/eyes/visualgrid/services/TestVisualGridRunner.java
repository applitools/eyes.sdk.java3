...
public class TestVisualGridRunner {
    ...
    public void testRunnerProxy() {
        ...
        Assert.assertNull(visualGridRunner.serviceRunner.getDefaultResourcesProxy());
        Assert.assertNull(visualGridRunner.serviceRunner.getCustomResourcesProxy());

        visualGridRunner = new VisualGridRunner(new RunnerOptions().proxy(p1));
        Assert.assertEquals(visualGridRunner.getProxy(), p1);
        Assert.assertEquals(visualGridRunner.serviceRunner.getDefaultResourcesProxy(), p1);
        Assert.assertNull(visualGridRunner.serviceRunner.getCustomResourcesProxy());
        ...
        Assert.assertEquals(visualGridRunner.getProxy(), p1);
        Assert.assertEquals(visualGridRunner.serviceRunner.getDefaultResourcesProxy(), p2);
        Assert.assertNull(visualGridRunner.serviceRunner.getCustomResourcesProxy());
        ...
        Assert.assertNull(visualGridRunner.serviceRunner.getDefaultResourcesProxy());
        Assert.assertEquals(visualGridRunner.serviceRunner.getCustomResourcesProxy(), p1);
        ...
        Assert.assertEquals(visualGridRunner.getProxy(), p1);
        Assert.assertNull(visualGridRunner.serviceRunner.getDefaultResourcesProxy());
        Assert.assertEquals(visualGridRunner.serviceRunner.getCustomResourcesProxy(), p2);
