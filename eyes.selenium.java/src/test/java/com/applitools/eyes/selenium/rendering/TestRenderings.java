...
public class TestRenderings extends ReportingTestSuite {
    ...
    public void testCaptureDomSnapshot() throws Exception {
        ...
        VisualGridEyes eyes = new VisualGridEyes(new VisualGridRunner0(10), configurationProvider);
    ...
    public void testMapRunningTestsToRequiredBrowserWidth() {
        ...
        VisualGridEyes eyes = spy(new VisualGridEyes(new VisualGridRunner0(10), configurationProvider));
