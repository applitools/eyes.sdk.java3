...
public class VisualGridRunner extends EyesRunner {
    ...
    public VisualGridRunner(RunnerOptions runnerOptions, String suiteName) {
        ...
        if (runnerOptions.isAutProxySet()) {
            serviceRunner.setAutProxy(runnerOptions.getAutProxy(), runnerOptions.getAutProxyDomains(), runnerOptions.getAutProxyMode());
        } else {
            if (runnerOptions.getProxy() != null) {
                serviceRunner.setAutProxy(runnerOptions.getProxy(), null, null);
            }
        }
    ...
    public void setProxy(AbstractProxySettings proxySettings) {
        ...
        if (proxySettings != null) {
            serviceRunner.setAutProxy(proxySettings, null, null);
        }
    }
